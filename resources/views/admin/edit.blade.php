                        ...
                        <div class="card-body">
                            ...
                            <form action="/admin/update/{{$admin->id}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                               placeholder="Insert the name" value="{{$admin->name}}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="username" name="username" class="form-control"
                                               placeholder="Insert the username" value="{{$admin->username}}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control"
                                               placeholder="Insert the email" value="{{$admin->email}}">
                                ...
                                <div class="modal-footer justify-content-between">
                                    <a type="button" class="btn btn-default" href="/admin">Close</a>
