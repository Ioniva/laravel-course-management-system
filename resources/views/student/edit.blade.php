                        ...
                        <div class="card-body">
                            ...
                            <form action="/student/update/{{$student->id}}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="name" name="name" class="form-control"
                                               placeholder="Insert the name" value="{{$student->name}}">
                                    </div>
                                    <div class="col-6">
                                        <label for="surname">surname</label>
                                        <input type="text" id="surname" name="surname" class="form-control"
                                               placeholder="Insert the surname" value="{{$student->surname}}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="text" id="username" name="username" class="form-control"
                                               placeholder="Insert the username" value="{{$student->username}}">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <input type="email" id="email" name="email" class="form-control"
                                               placeholder="Insert the email" value="{{$student->email}}">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="number" id="telephone" name="telephone" class="form-control"
                                               placeholder="Insert the phone number" value="{{$student->telephone}}">
                                    </div>
                                    <div class="col-6">
                                        <label for="nif">CIF/NIF/NIE</label>
                                        <input type="text" id="nif" name="nif" class="form-control"
                                               placeholder="Insert the surname" value="{{$student->nif}}">
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer justify-content-between">
                                    <a type="button" class="btn btn-default" href="/student">Close</a>
