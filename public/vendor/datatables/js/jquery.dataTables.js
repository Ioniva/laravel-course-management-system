...
(function( $, window, document, undefined ) {
	...
	DataTable.defaults = {
		 ...
		 * generate suitable exams-up for a site. For example the Bootstrap
		 * integration plug-in for DataTables uses a paging button renderer to
		 * display pagination buttons in the exams-up required by Bootstrap.
		 *
	...
	$.extend( true, DataTable.ext.renderer, {
		header: {
			_: function ( settings, cell, column, classes ) {
				// No additional exams-up required
