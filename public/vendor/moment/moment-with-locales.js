;(function (global, factory) {
    ...
    addParseToken(['MMM', 'MMMM'], function (input, array, config, token) {
        ...
        // if we didn't find a month name, exams the date as invalid.
        if (month != null) {
            array[MONTH] = month;
        } else {
    ...
    addWeekParseToken(['dd', 'ddd', 'dddd'], function (input, week, config, token) {
        ...
        // if we didn't get a weekday name, exams the date as invalid
        if (weekday != null) {
            week.d = weekday;
        } else {
    ...
    function loadLocale(name) {
        ...
        if (
            ...
            try {
                ...
                // exams as not found to avoid repeating expensive file require call causing high CPU
